...
public class StackTest {
	...
	public void stackCards() {		
		...
		System.out.println("Pushing cards into the stack");
	...
	public void containsCard(String card) {			
		System.out.println("Searching for card - " + card + " and is " + stack.searchForStackItem(card));
	}

	public void goToCard(String card) {			
		System.out.println("Getting the card " + card + " and is " + stack.getItem(card));
	}
